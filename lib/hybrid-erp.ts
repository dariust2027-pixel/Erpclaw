...
export type OutboxAction = { id: string; action: string; args: Record<string, unknown>; createdAt: string; status: "pending" | "syncing" | "synced" | "conflict"; message?: string };
...
export const queue = (action: string, args: Record<string, unknown>): OutboxAction => ({ id: makeId("outbox"), action, args, createdAt: new Date().toISOString(), status: "pending" });
